...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  /* Enhanced Security Middleware with Helmet.js */
  console.log('Applying enhanced security headers with Helmet.js...')
  ...
  app.use(helmet.ieNoOpen()) // Set X-Download-Options for IE8+
